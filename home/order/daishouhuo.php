...
<body>
	...
	session_start();
      ...
      {
      	$sql="select orders.*,goods.* from orders,goods where orders.GoodsID=goods.GoodsID and orders.UserName='".$_SESSION['username']."' and orders.StatusID=4";
		 echo $sql;
		...
		<tr>
			...
			<td>总价:<?php echo $row['Price']*$row['Counts']; ?></td>&nbsp; 
		</tr>
	<?php
	}
  }
